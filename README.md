...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/alvinxhc/doubi/master/ssr.sh && chmod +x ssr.sh && bash ssr.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/alvinxhc/doubi/master/mtproxy.sh && chmod +x mtproxy.sh && bash mtproxy.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/alvinxhc/doubi/master/mtproxy_go.sh && chmod +x mtproxy_go.sh && bash mtproxy_go.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/alvinxhc/doubi/master/status.sh && chmod +x status.sh && bash status.sh
```
